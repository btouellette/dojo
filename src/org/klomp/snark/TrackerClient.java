/* TrackerClient - Class that informs a tracker and gets new peers. Copyright (C) 2003 Mark J. Wielaard
 * 
...
public class TrackerClient extends Thread
{
	...
	private TrackerInfo doRequest(String announce, String infoHash, String peerID, long uploaded, long downloaded, long left, String event) throws IOException
	{
	...
	/**
	 * The maximum number of times that we are allowed to fail to make an initial contact with the tracker before we bail
	 */
