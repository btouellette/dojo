/* PeerListener - Interface for listening to peer events. Copyright (C) 2003 Mark J. Wielaard
 * 
...
public interface PeerListener
{
	...
	/**
	 * Called when the peer wants (part of) a piece from us. Only called when the peer is not choked by us (<code>peer.choke(false)</code> was called).
	 * 
	 * @param peer
	...
	/**
	 * Called when we are downloading from the peer and need to ask for a new piece. Might be called multiple times before <code>gotPiece()</code> is called.
	 * 
	 * @param peer
