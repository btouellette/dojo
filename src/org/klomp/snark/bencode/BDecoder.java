/* BDecoder - Converts an InputStream to BEValues. Copyright (C) 2003 Mark J. Wielaard
 * 
...
public class BDecoder
{
	 ...
	 *                when the stream doesn't start with a bencoded value or the stream isn't a bencoded stream at all.
	...
	/**
	 * Returns what the next bencoded object will be on the stream or -1 when the end of stream has been reached. Can return something unexpected (not '0' .. '9', 'i', 'l' or 'd') when the stream isn't bencoded.
	 * 
	...
	/**
	 * Returns the next byte read from the InputStream (as int). Throws EOFException if InputStream.read() returned -1.
	 */
