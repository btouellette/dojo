...
public class SnarkApplication
{
	...
	protected static void usage(String s)
	{
		...
		stream.println("         \t(defaults to " + Level.SEVERE + ", with --debug to " + Level.INFO + ", highest level is " + Level.ALL + ").");
		...
		stream.println("        \t(if not given defaults to first free port between " + Snark.MIN_PORT + "-" + Snark.MAX_PORT + ").");
	...
	/**
	 * A convenience method for parsing arguments passed via the command line where no overriding of the listeners is required.
	 */
