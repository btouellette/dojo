...
public class Snark
{
	 ...
	 * 
	 * @param torrent
	 *            The address of the torrent to download or file to serve
	 * @param ip
	 *            The IP address to use when serving data
	 * @param user_port
	 *            The port number to use
	 * @param slistener
	 *            A custom {@link StorageListener} to use
	 * @param clistener
	 *            A custom {@link CoordinatorListener} to use
	 */
	public Snark(String torrent, String ip, int user_port, StorageListener slistener, CoordinatorListener clistener)
	{
	...
	/**
	 * Establishes basic information such as {@link #id}, opens ports, and determines whether to act as a peer or seed.
	 */
	...
	/**
	 * Start the upload/download process and begins exchanging pieces with other peers.
	 */
	public void collectPieces() throws IOException
	{
	 ...
	 */
	public static void abort(String s) throws IOException
	{
		abort(s, null);
	}
	 ...
	 * Aborts program abnormally.
	 */
	public static void abort(String s, IOException ioe) throws IOException
	{
	...
	protected static final String[] activities = { "Not started", "Network setup", "Getting torrent", "Creating torrent", "Checking storage", "Collecting pieces", "Seeding" };
