/* PeerID - All public information concerning a peer. Copyright (C) 2003 Mark J. Wielaard
 * 
...
public class PeerID implements Comparable
{
	...
	public boolean equals(Object o)
	{
		if (o instanceof PeerID) {
			...
			return port == pid.port && address.equals(pid.address) && sameID(pid);
		} else {
			return false;
		}
	}
	...
	/**
	 * Returns the String "id@address:port" where id is the hex encoded id with leading zeros removed.
	 */
	@Override
