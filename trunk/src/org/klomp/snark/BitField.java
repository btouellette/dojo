/* BitField - Container of a byte array representing set and unset bits. Copyright (C) 2003 Mark J. Wielaard
 * 
...
public class BitField
{
	...
	/**
	 * Creates a new BitField that represents <code>size</code> bits as set by the given byte array. This will make a copy of the array. Extra bytes will be ignored.
	 * 
	...
	/**
	 * This returns the actual byte array used. Changes to this array effect this BitField. Note that some bits at the end of the byte array are supposed to be always unset if they represent bits bigger then the size of the bitfield.
	 */
