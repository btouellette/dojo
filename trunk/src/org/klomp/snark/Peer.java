/* Peer - All public information concerning a peer. Copyright (C) 2003 Mark J. Wielaard
 * 
...
public class Peer implements Comparable<Peer>
{
	 ...
	 */
	public Peer(final Socket sock, BufferedInputStream bis, BufferedOutputStream bos, byte[] my_id, MetaInfo metainfo) throws IOException
	{
		this.my_id = my_id;
		this.metainfo = metainfo;
	...
	/**
	 * Returns the number of bytes that have been downloaded. Can be reset to zero with <code>resetCounters()</code>/
	 */
	...
	/**
	 * Returns the number of bytes that have been uploaded. Can be reset to zero with <code>resetCounters()</code>/
	 */
