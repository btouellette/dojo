/* TrackerInfo - Holds information returned by a tracker, mainly the peer list. Copyright (C) 2003 Mark J. Wielaard
 * 
...
public class TrackerInfo
{
	...
	public static Set<Peer> getPeers(List l, byte[] my_id, MetaInfo metainfo) throws IOException
	{
