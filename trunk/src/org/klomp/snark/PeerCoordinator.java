/* PeerCoordinator - Coordinates which peers do what (up and downloading). Copyright (C) 2003 Mark J. Wielaard
 * 
...
public class PeerCoordinator implements PeerListener
{
	 ...
	 */
	public byte[] gotRequest(Peer peer, int piece) throws IOException
	{
		if (halted) {
			return null;
		}
